...
const InspectorProperties = preload("res://addons/babylonian/object-inspector/scripts/inspector_properties.gd")
const Paginator = preload("res://addons/babylonian/object-inspector/scripts/inspector_property_paginator.gd")
