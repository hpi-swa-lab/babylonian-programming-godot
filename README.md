...
# Halo - Runtime Object Editor with options to persist changes

The Halo is a runtime tool for selecting, inspecting, and modifying game objects while the game is running. See the [Halo documentation](addons/babylonian/halo/readme.md) for usage, configuration, and custom tool development.
